...
import { useParams, Link } from 'https://esm.sh/wouter@3/preact';
import { motion } from 'https://esm.sh/framer-motion?alias=react:preact/compat,react-dom:preact/compat';
import { ArrowLeft, Download, FileText, Play, Image as ImageIcon } from 'https://esm.sh/lucide-preact';
import { CURRICULUM_DATA } from '../constants.js';
