...
import { ArrowRight, ChevronDown, CheckCircle2, GraduationCap, Zap, BookOpen, Users, Globe } from 'lucide-react';
  ...
  const features = [
    {
      ...
      desc: "Detailed chapter-wise notes compiled from top resources and examiner reports."
    },
    {
      icon: Zap,
      title: "Topical Practice",
      desc: "Sorted past paper questions to help you master specific topics one by one."
    },
    {
      icon: GraduationCap,
      title: "Revision Guides",
      desc: "The essential 'must-knows' for every subject, simplified for last-minute review."
    },
    {
      icon: Users,
      title: "Student Forum",
      desc: "Connect with others taking the same exams and share insights."
    },
    {
      icon: Globe,
      title: "Global Reach",
      desc: "Used by students worldwide following the Cambridge international curriculum."
    },
    {
      icon: Zap,
      title: "Regular Updates",
      desc: "We stay on top of syllabus changes so you always have current material."
    }
  ];
